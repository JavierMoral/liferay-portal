...
public class
	LayoutPageTemplateCollectionKeyInvalidCharacterExceptionProblemMapper
		implements ProblemMapper
			<LayoutPageTemplateCollectionLayoutPageTemplateCollectionKeyException.MustNotContainInvalidCharacters> {
