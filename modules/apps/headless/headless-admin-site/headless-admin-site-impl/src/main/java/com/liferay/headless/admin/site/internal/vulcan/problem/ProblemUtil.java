...
public class ProblemUtil {
	...
	public static <T extends Throwable> Problem getTooLongProblem(
		String field, int maxLength, T throwable) {

		String title = "The " + field + " is too long";

		String detail = title;

		if (maxLength > 0) {
			detail = StringBundler.concat(
				"The ", field, " exceeds the maximum length of ", maxLength,
				" characters");
		}
