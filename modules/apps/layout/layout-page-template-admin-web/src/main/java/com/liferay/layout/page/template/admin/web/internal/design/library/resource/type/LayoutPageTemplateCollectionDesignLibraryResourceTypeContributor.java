...
public class LayoutPageTemplateCollectionDesignLibraryResourceTypeContributor
	...
	public List<DesignLibraryResourceCreationItem> getCreationItems(
		...
		Map<String, Object> baseModuleProps = _getBaseModuleProps(
			backURL, depotEntry.getGroup(), httpServletRequest);

		return ListUtil.fromArray(
			_newCreationItem(
				baseModuleProps, httpServletRequest,
				"add-content-page-template", "new-content-page-template",
				"page-template"),
			_newCreationItem(
				baseModuleProps, httpServletRequest, "add-page-template-set",
				"new-page-template-set", "set"));
	}
	...
	private Map<String, Object> _getBaseModuleProps(
		String backURL, Group depotGroup,
