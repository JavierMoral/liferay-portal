...
public class AssetDisplayPageUsagesDisplayContextTest {
	...
	public void testGetSearchContainer() throws Exception {
		...
		Assert.assertEquals(
			...
			actualAssetDisplayPageEntry1.getLayoutPageTemplateEntryId());
		Assert.assertEquals(
			assetDisplayPageEntry2.getAssetDisplayPageEntryId(),
			actualAssetDisplayPageEntry2.getLayoutPageTemplateEntryId());
	}
	...
	private SearchContainer<AssetDisplayPageEntry> _getSearchContainer(
		...
		return ReflectionTestUtil.invoke(
			mockLiferayPortletRenderRequest.getAttribute(
				"com.liferay.layout.page.template.admin.web.internal.display.context.AssetDisplayPageUsagesDisplayContext"),
	...
	@Inject(
		filter = "mvc.command.name=/layout_page_template_admin/view_asset_display_page_usages",
