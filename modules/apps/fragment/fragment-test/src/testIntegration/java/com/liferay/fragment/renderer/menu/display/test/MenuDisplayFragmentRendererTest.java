...
public class MenuDisplayFragmentRendererTest {
	...
	public void testRender() throws Exception {
		...
		SiteNavigationMenuItem siteNavigationMenuItem =
			_addURLSiteNavigationMenuItem(
				_group.getGroupId(), siteNavigationMenu,
		...
		Assert.assertTrue(
			content.contains(typeSettingsUnicodeProperties.get("url")));
	}

	@Test
	@TestInfo("LPD-64102")
	public void testRenderCompanyGroup() throws Exception {
		...
		SiteNavigationMenuItem siteNavigationMenuItem =
			_addURLSiteNavigationMenuItem(
				companyGroup.getGroupId(), siteNavigationMenu,
				companyGroup.getDefaultLanguageId());
	...
	@Test
	@TestInfo("LPD-64102")
	public void testRenderCompanyGroupUsingERC() throws Exception {
		Group companyGroup = _groupLocalService.getCompanyGroup(
			TestPropsValues.getCompanyId());
	...
	@Test
	@TestInfo("LPD-64102")
	public void testRenderUsingERC() throws Exception {
		SiteNavigationMenu siteNavigationMenu = _addSiteNavigationMenu(
			_group.getGroupId());
	...
	private SiteNavigationMenuItem _addURLSiteNavigationMenuItem(
			long groupId, SiteNavigationMenu siteNavigationMenu,
